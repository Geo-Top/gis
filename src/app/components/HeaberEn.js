...
export default function HeaderEn({link}) {
  ...
  const links = [
    { href: "/home/en", text: "Home" },
    { href: "/courses/en", text: "Courses" },
    { href: "/instructors/en", text: "Instructors" },
    { href: "/contact/en", text: "Contact" },
    { href: "/https://geo-top.github.io/geotop/", text: "Geo Top" },
  ];
  const lang = "AR"
  const languageSwitchLink = `${link}/ar`;

  return (
    <header dir="ltr" className="flex items-center justify-between px-4 py-3">
      {/* Logo and Site Name */}
      <Link href="/">
        <div className="flex items-center gap-2">
          <img
            ...
            className="w-10 h-10"
          />
          <h1 className="text-xl font-bold text-[#007bff]"> Geo Top Courses</h1>
        </div>
      </Link>
